...
@attached(accessor)
public macro DictionaryStorageProperty() = #externalMacro(module: "MacrosImplementation", type: "DictionaryStoragePropertyMacro")
...
@attached(accessor)
public macro ObservableProperty() = #externalMacro(module: "MacrosImplementation", type: "ObservablePropertyMacro")
