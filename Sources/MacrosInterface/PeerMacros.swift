...
/// handler.
@attached(peer, names: overloaded)
public macro AddCompletionHandler() = #externalMacro(module: "MacrosImplementation", type: "AddCompletionHandlerMacro")

// MARK: - Peer Value With Suffix Name

@attached(peer, names: suffixed(_peer))
public macro PeerValueWithSuffixName() = #externalMacro(module: "MacrosImplementation", type: "PeerValueWithSuffixNameMacro")
